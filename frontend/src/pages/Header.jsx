...
<h1 className=" text-4xl font-boldleading-none tracking-tight text-gray-900 md:text-5xl lg:text-3xl dark:text-white">Snippetz <span className="text-blue-500 dark:text-blue-500">Institute</span></h1>
</Link>
