...
const Home2 = () => {
    const arr = [{name:"Midoriya",position:"Head Of Institue",quote:"The CEO's role in raising a company's corporate IQ is to establish an atmosphere that promotes knowledge sharing and collaboration.",src:"https://cdn.tuk.dev/assets/photo-1564061170517-d3907caa96ea.jfif"},
{name:"Nami",position:"Principal",quote:"Empowering minds, shaping futures bright,,Our school's community, a guiding light.Together we learn, grow and thrive",src:"https://cdn.tuk.dev/assets/photo-1530577197743-7adf14294584.jfif"},
{name:"Alex",position:"IT Support Specialist",quote:"Connecting technology, empowering minds,Solutions delivered, with expert finds.Supporting your success, always online",src:"https://cdn.tuk.dev/assets/photo-1566753323558-f4e0952af115.jfif"},
{name:"Thomas",position:"Maintenance Officer",quote:"Protecting assets, with diligent care,Ensuring functionality, everywhere,Maintenance excellence, we declare.",src:"https://cdn.tuk.dev/assets/photo-1570211776045-af3a51026f4a.jfif"}
]
  return (
    <>
    <Header/>
    ...
    <dh-component>
        <div class="container flex justify-center mx-auto pt-16 main_home2">
            <div>
                {/* <p class="text-gray-500 text-lg text-center font-normal pb-3">Snippetz Institue</p> */}
                <h1 class="xl:text-4xl text-3xl text-center text-gray-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">The Talented People Behind the Scenes of the Institute</h1>
            </div>
        </div>
                    ...
                    return <>
                        ...
                        <div class="rounded overflow-hidden shadow-md bg-white">
                            <div class="absolute -mt-20 w-full flex justify-center">
                                <div class="h-32 w-32">
                                    <img src={data.src} alt="Display Picture of Andres Berlin" role="img" class="rounded-full object-cover h-full w-full shadow-md" />
                                </div>
                            </div>
                            <div class="px-6 mt-16">
                                <h1 class="font-bold text-3xl text-center mb-1">{data.name}</h1>
                                <p class="text-gray-800 text-sm text-center">{data.position}</p>
                                <p class="text-center text-gray-600 text-base pt-3 font-normal">{data.quote}</p>
