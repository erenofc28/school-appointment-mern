  ...
  <Header/>
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className=" mx-auto grid max-w-7xl gap-20 px-6 lg:px-8 xl:grid-cols-3">
          ...
          {/* <div className="main-div-search2  flex items-center max-w-sm mx-auto">   
    <label for="simple-search" className="sr-only">Search</label>
    <div className="relative w-full search-div2">
        <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
        
        </div>
        <input onChange={(e)=>{setSearch(e.target.value)}} type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 s-input" placeholder="Search Teacher" required />
    </div>

    <button onClick={handleSearch} type="submit" className="search-btn2 p-2.5 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    <button onClick={()=>{setReset(Math.random())}} type="submit" className="search-btnr p-2.5 ms-2 text-sm font-medium text-blue-500 bg-white-700 rounded-lg border border-blue-700 hover:bg-white-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-white-700 dark:focus:ring-white-800">
  <p>⟳</p>  
    </button>
...
<button onClick={()=>{setReset(Math.random())}} type="submit" className="search-btnr p-2.5 ms-2 text-sm font-medium text-blue-500 bg-white-700 rounded-lg border border-blue-700 hover:bg-white-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-white-700 dark:focus:ring-white-800">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
            ...
            <Link to="/schedule">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8 plus-icon ">
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
</svg> 
</Link>  
            </>:""}
...
</>:""}
{
  ...
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-7 plus-icon plus-icon-t">
