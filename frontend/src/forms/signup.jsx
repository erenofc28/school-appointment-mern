...
const AddTeacher = () => {
  ...
  const handleSignUp = async () => {
    ...
    await axios
      .post(`http://localhost:5000/` + signup_type, data)
      .then((res) => {
  ...
  return (
    <>
      <Header />
      <div
        className="body-form1 flex justify-center items-center mt-24"
        style={{ height: "auto" }}
      >
